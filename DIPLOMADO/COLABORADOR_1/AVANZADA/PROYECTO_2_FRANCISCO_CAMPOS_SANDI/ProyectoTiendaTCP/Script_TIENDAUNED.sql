...
Create table Sucursal(
	...
	telefono varchar(12),
	id_administrador  numeric (11,0),
	activo bit not null,
	constraint pk_sucursal primary key (id),
	constraint fk_sucursal01 foreign key (id_administrador) references Administrador (identificacion)
)
...
Create table ArticuloxSucursal (
	...
	constraint pk_articuloxsucursal primary key (id_sucursal,id_articulo),
...
Create table Reserva (
	...
	constraint fk_reserva01 foreign key (id_sucursal,id_articulo) references ArticuloxSucursal (id_sucursal,id_articulo),
