...
public final class ValidadorBeginEnd {
    ...
    public List<Diagnostico> verificar(Fuente fuente) {
        ...
        int lineaBegin = primeraLineaPalabraExacta(lineas, "begin"); // solo 'begin' (con/sin espacios a los lados)
    ...
    private static int primeraLineaPalabraExacta(String[] lineas, String palabra) {
        for (int i = 0; i < lineas.length; i++) {
            String s = quitarNumeroLinea(lineas[i]).trim();
