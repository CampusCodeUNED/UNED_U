...
public class Analizar {
    ...
    public void AnalizaLinea(String TxtLinea, ControlesTotales crtlTotal)
    {
                        ...
                        if (parte.toUpperCase().matches(comparaTOKENS.patron))
                        {
                            switch (comparaTOKENS) {
                                case Reservada:
                                    ...
                                    break;
                                case Numeros:
                                    //System.out.println(parte+"  Es un número");
                                    encontrado="SI";
                                    tipoDato="Numeros";
                                    break;
                                case Variable:
                                ...
                                case Operadores:
                                    ...
                                    break;
                                case Parentesis:     
                                    //System.out.println(parte+"  Es un paréntesis");
                                    encontrado="SI";
                                    tipoDato="Parentesis";
                                    break;
                                case Separadores:     
        ...
        System.out.println(Colores.ANSI_CYAN+" Línea obtenida seperada-->> "+ LineaReal);
        System.out.println(LineaProcesada);
        System.out.println(Colores.ANSI_PURPLE+"<<<<---------PROCESADO----------->>>"+Colores.ANSI_RESET);
        
        VerificaSintaxis comprueba = new VerificaSintaxis();
        if (comprueba.revisaSintaxis(LineaProcesada,LineaReal,crtlTotal)==true){
