...
public final class ValidadorComentarios {
    ...
    public Result check(Fuente fuente) {
    ...
    // Valida los comentarios en una línea específica
    ...
    // Valida comentarios con // en una línea específica
    ...
    // Valida comentarios después de punto y coma en una línea específica
    ...
    // Valida la posición de los comentarios en relación a program y end.
    ...
    // Verifica si una línea es completamente un comentario
    public static boolean isCommentLine(String linea) {
        if (linea == null) {
            return false;
        }
    ...
    // Obtiene la línea donde aparece la palabra "program"
    ...
    // Obtiene la última línea donde aparece "end."
