...
public final class ValidadorEncabezadoProgram {
    ...
    public List<Diagnostico> check(Fuente fuente, String raizArchivo) {
    ...
    // Quita comentarios y cadenas de una línea para facilitar análisis
    ...
    // Verifica si una cadena contiene una palabra específica como palabra completa
